export const BBQ_DATA = [
  { id: 1, name: "Merguez Artisanales", category: "boeuf", method: "Directe", time: "8m", target: "75°C", icon: "Flame", wood: "Vigne", desc: "Ne jamais piquer pour garder le jus épicé à l'intérieur.", amazon: "https://www.amazon.fr/s?k=grille+bbq+kettle" },
  { id: 2, name: "Chicken Wings Crispy", category: "volaille", method: "Indir/Dir", time: "25m", target: "74°C", icon: "Zap", wood: "Pommier", desc: "Utilisez le rub 'Crispy' (levure chimique) pour une peau craquante.", amazon: "https://www.amazon.fr/s?k=rub+bbq+halal" },
  { id: 3, name: "Côte de Bœuf (Reverse Sear)", category: "boeuf", method: "Indir/Dir", time: "45m", target: "54°C", icon: "Award", wood: "Chêne", desc: "Saisir en direct à la fin pour une croûte de Maillard parfaite.", amazon: "https://www.amazon.fr/s?k=thermometre+viande+professionnel" },
  { id: 4, name: "Pdt en Papillote (Alu)", category: "legumes", method: "Indirecte", time: "45m", target: "92°C", icon: "Box", wood: "Chêne", desc: "Enveloppez avec du beurre, du gros sel et du romarin.", amazon: "https://www.amazon.fr/s?k=panier+legumes+bbq" },
  { id: 5, name: "Maïs Doux (Épis)", category: "legumes", method: "Directe", time: "15m", target: "Caramélisé", icon: "Flame", wood: "Pommier", desc: "Retournez toutes les 3 min. Badigeonnez de beurre salé.", amazon: "https://www.amazon.fr/s?k=pique+mais+bbq" },
  { id: 6, name: "Pavé de Saumon sur Planche", category: "poisson", method: "Planche", time: "12m", target: "63°C", icon: "Fish", wood: "Cèdre", desc: "Cuisinez sur une planche de cèdre trempée 2h dans l'eau.", amazon: "https://www.amazon.fr/s?k=planche+cedre+bbq" },
  { id: 7, name: "Aubergines Grillées", category: "legumes", method: "Directe", time: "8m", target: "Fondant", icon: "Leaf", wood: "Vigne", desc: "Huilez généreusement chaque face avant la pose.", amazon: "https://www.amazon.fr/s?k=accessoire+legumes+bbq" },
  { id: 8, name: "Short Ribs de Bœuf (Dino Ribs)", category: "boeuf", method: "Indirecte", time: "8h", target: "93°C", icon: "Timer", wood: "Hickory", desc: "Le Graal du BBQ Low & Slow. La viande doit être souple comme du beurre.", amazon: "https://www.amazon.fr/s?k=support+ribs+bbq" },
  { id: 9, name: "Picanha de Bœuf Entière", category: "boeuf", method: "Indir/Dir", time: "50m", target: "52°C", icon: "Flame", wood: "Cerisier", desc: "Tranchez le gras en losange, démarrez en indirect côté chair.", amazon: "https://www.amazon.fr/s?k=couteau+trancher+viande" },
  { id: 10, name: "Magret de Canard au Poivre", category: "canard", method: "Indirecte", time: "25m", target: "54°C", icon: "TrendingUp", wood: "Pécan", desc: "Cuisson indirecte exclusive côté peau pour fondre le gras sans flamme.", amazon: "https://www.amazon.fr/s?k=accessoire+kettle+weber" },
  { id: 11, name: "Poulpe Grillé Smoky", category: "poisson", method: "Directe", time: "6m", target: "Croustillant", icon: "Activity", wood: "Aulne", desc: "Blanchir le poulpe avant, puis le raidir à feu ultra-vif avec un filet d'huile de sésame.", amazon: "https://www.amazon.fr/s?k=pince+barbecue+longue" }
];
...
export const RECIPES = [
  {
    ...
    gear: { name: "Thermomètre à sonde", link: "https://www.amazon.fr/s?k=thermometre+bbq" }
  },
  {
    id: "r2",
    ...
    gear: { name: "Papier de boucher BBQ", link: "https://www.amazon.fr/s?k=butcher+paper+bbq" }
  },
  {
    id: "r3",
    ...
    gear: { name: "Pince de précision", link: "https://www.amazon.fr/s?k=pince+bbq" }
  },
  {
    id: "r4",
    ...
    gear: { name: "Grille en fonte de saisie", link: "https://www.amazon.fr/s?k=grille+fonte+bbq+kettle" }
  }
];
...
export const SHOP_ITEMS = [
  { id: 's1', name: "Thermomètre Instantané", rating: 4.8, img: "🌡️", link: "https://www.amazon.fr/s?k=thermometre+bbq", sponsor: true },
  { id: 's2', name: "Cheminée d'Allumage", rating: 4.9, img: "🔥", link: "https://www.amazon.fr/s?k=cheminee+allumage+bbq", sponsor: false }
];
